...
public class CloudSimTags {
	...
	// VMMgr required
	public static final int VM_LIST_CREATE = BASE + 49;
	
	// VMMgr required
	public static final int VM_LIST_CREATE_ACK = BASE + 50;

	// provision required
	public static final int CLOUDLET_INIT = BASE+ 51;
	
	// provision required
	public static final int ADAPT_PROVISION = BASE+ 52;
	
	// provision required
	public static final int VM_RT_CREATE = BASE + 53;
	
	// provision required
	public static final int VM_RT_DESTROY = BASE + 54;
	
	// provision required
	public static final int DATACENTER_CLEAR = BASE + 55;
