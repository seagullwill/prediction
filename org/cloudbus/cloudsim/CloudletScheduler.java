...
public abstract class CloudletScheduler {
	...
	public abstract int getAvaliablePEs();

	public abstract List<? extends Cloudlet> getExecList();
	
	public abstract double estimateFinishTime(Cloudlet cloudlet, double fileTransferTime) ;
