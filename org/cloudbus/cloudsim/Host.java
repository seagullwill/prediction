...
public class Host {
	...
	public double updateVmsProcessing(double currentTime) {
		...
		//Log.printLine("update time:"+ smallerTime);
		return smallerTime;
	}
	 ...
	 */
	public boolean isSuitableForVm(Vm vm) {Log.printLine("host检查是否适合vm"+vm.getId());
	...
	public Vm getVm(int vmId, int userId) {
		for (Vm vm : getVmList()) {//Log.printLine("host里面vm:"+vm.getId()+"传入vmid："+vmId+"userid:"+userId);
